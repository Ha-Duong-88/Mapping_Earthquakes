...
// First, create the map object with a center and zoom level.
...
// In the base layer code, the Street and Dark keys set the text, which we will see in the index.html, while 
// the corresponding values reference the tile layers.
let baseMaps = {
    Street: streets,
    Dark: dark
  };
...
// To complete the code for the map layers, use the Leaflet control.layers, which will control the layers we'll 
// see on the map.
// The argument passed, baseMaps, is the base layer object, which will allow the two different map styles to be 
//shown on the index.html file. 
...
let airportData = "https://raw.githubusercontent.com/Ha-Duong-88/Mapping_Earthquakes/main/majorAirports.json";
